                ...
                <div class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 bg-gray-50 p-5 rounded-xl border border-gray-100">
                        <div>
                            ...
                            <span class="text-xl font-extrabold text-gray-900">{{ $class }}</span>
                        </div>
                        <div>
                            <span class="text-xs font-bold text-gray-400 uppercase tracking-wider block">Tingkat Keyakinan (CF)</span>
                            <span class="text-xl font-extrabold text-indigo-600">{{ $confidence }}%</span>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-4">
                        ...
                        @if($class === 'Diagnosa Gagal' || $class === 'Bukan Mata')
                            <div class="space-y-4">
