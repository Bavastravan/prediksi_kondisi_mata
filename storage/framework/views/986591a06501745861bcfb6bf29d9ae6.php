    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl p-8 border border-gray-100">
                <form action="<?php echo e(route('diagnosa.store')); ?>" method="POST" enctype="multipart/form-data" id="form-diagnosa">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $gejala; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center p-3 border border-gray-100 rounded-xl cursor-pointer hover:bg-indigo-50 transition-colors group">
                                        <input type="checkbox" name="symptoms[]" value="<?php echo e($g['val']); ?>" 
                                            class="rounded text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                        <span class="ml-3 text-gray-700 group-hover:text-indigo-700 transition-colors text-sm"><?php echo e($g['label']); ?></span>
                                    </label>
...
<?php endif; ?><?php /**PATH D:\XampUtama\htdocs\prediksi_kondisi_mata\resources\views/diagnosa.blade.php ENDPATH**/ ?>